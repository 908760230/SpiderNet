...
namespace SpiderNet
{
	...
	private:
		...
		ExceptionFactory() {}
		static SPIDERNET_NO_RETURN void _throwException(
			...
			const std::string &src, const char *file, long line)
		{
			...
			case Exception::ERR_INVALID_PARAMS:
			...
			case Exception::ERR_NOT_CONSTRUCTED:
				throw UnconstructedException(number, desc, src, file, line);
			default:
	...
	public:
		static SPIDERNET_NO_RETURN void throwException(
